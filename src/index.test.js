...
describe("CSS Grid", () => {
    ...
    describe("Page sceleton", () => {
        it('should add "grid-template-columns" property to body', async () => {
            ...
            expect(styleDeclaration["grid-template-columns"]).toBe(
                "repeat(12, 1fr)"
            );
        });
        ...
        it('should add "grid-template-areas" property to body', async () => {
            ...
            expect(styleDeclaration["grid-template-areas"])
    ...
    describe('"Features" section', () => {
        ...
        it("should order grid items properly", async () => {
            await waitBrowserLoadEvent(document);
            const firstColStyleDeclaration = getStyleDeclarationForSelector(
                ".card-first",
                document.styleSheets
            );
            const secondColStyleDeclaration = getStyleDeclarationForSelector(
                ".card-second",
                document.styleSheets
            );
            const thirdColStyleDeclaration = getStyleDeclarationForSelector(
                ".card-third",
                document.styleSheets
            );
            const fourthColStyleDeclaration = getStyleDeclarationForSelector(
                ".card-fourth",
                document.styleSheets
            );
            const fifthColStyleDeclaration = getStyleDeclarationForSelector(
                ".card-fifth",
                document.styleSheets
            );
            const sixColStyleDeclaration = getStyleDeclarationForSelector(
                ".card-six",
                document.styleSheets
            );
